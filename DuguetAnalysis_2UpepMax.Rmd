...
q099 <- quantile(CV, 0.01, na.rm = T)
q090 <-quantile(CV, 0.1, na.rm = T)
...
The median of technical CVs is `r medCV`, 99% of the CVs are above `r q099` and 90% are above `r q090`.
...
The median of biological CVs is `r medCV`, 99% of the CVs are above `r q099` and 90% are above `r q090`.
