...
mat2 <- cbind(mat2, "GeneSymbol" = maptab[,2][match(rownames(mat2), maptab[,1])])
write.csv(mat2, "ExpressionData/ExpressionDataReanalysed.csv")
```

```{r}
mat3 <- mat2[,grepl("Treg", colnames(mat2)) | grepl("Tconv", colnames(mat2))]
mat3 <- mat3[,!grepl("Act", colnames(mat3)) & !grepl("Thy", colnames(mat3))]
rownames(mat3) <- mat2[,ncol(mat2)]
head(mat3)
...
save(nmat, mat3, file = "ExpressionData/ExpData.Rdata")
```
